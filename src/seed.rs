...
use super::{
    folded_multiply, ARBITRARY10, ARBITRARY11, ARBITRARY12, ARBITRARY13, ARBITRARY2, ARBITRARY6,
...
impl SharedSeed {
    ...
    pub const fn from_u64(seed: u64) -> Self {
        ...
        let seed_g = mix!(mix!(mix!(seed_f)));
        let seed_h = mix!(mix!(mix!(seed_g)));
...
mod global {
    ...
    static GLOBAL_SEED_STORAGE: GlobalSeedStorage = GlobalSeedStorage {
        ...
        seed: UnsafeCell::new(SharedSeed { seeds: [0; 8] }),
    };
